...
SET @sessionCleanupTime = cast((DATEDIFF(second, '1970-01-01 00:00:00', GETUTCDATE()) - (20160*60))AS DECIMAL) * 1000000000
-- Operational data older than 720 minutes(12 h) will be removed.
SET @operationCleanupTime = cast((DATEDIFF(second, '1970-01-01 00:00:00', GETUTCDATE()) - (720*60))AS DECIMAL) * 1000000000
...
IF (EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'IDN_AUTH_SESSION_STORE_TMP'))
DROP TABLE IDN_AUTH_SESSION_STORE_TMP;
IF (EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'TEMP_SESSION_BATCH'))
